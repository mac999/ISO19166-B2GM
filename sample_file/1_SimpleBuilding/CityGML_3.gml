...
<CityModel xmlns="http://www.opengis.net/citygml/3.0" xmlns:con="http://www.opengis.net/citygml/construction/3.0"
  ...
  <cityObjectMember>
    <bldg:Building gml:id="_Simple_BD.1">
      <boundary>
        <con:WallSurface gml:id="_Simple_BD.1_WallSurface_1">
          <lod2MultiSurface>
            <gml:MultiSurface>
              <gml:surfaceMember>
      ...
      <boundary>
        <con:WallSurface gml:id="_Simple_BD.1_WallSurface_2">
          <lod2MultiSurface>
            <gml:MultiSurface>
              <gml:surfaceMember>
      ...
      <boundary>
        <con:WallSurface gml:id="_Simple_BD.1_WallSurface_3">
          <lod2MultiSurface>
            <gml:MultiSurface>
              <gml:surfaceMember>
      ...
      <boundary>
        <con:WallSurface gml:id="_Simple_BD.1_WallSurface_4">
          <lod2MultiSurface>
            <gml:MultiSurface>
              <gml:surfaceMember>
      ...
      <boundary>
        <con:RoofSurface gml:id="_Simple_BD.1_RoofSurface_1">
          <lod2MultiSurface>
            <gml:MultiSurface>
              <gml:surfaceMember>
      ...
      <boundary>
        <con:GroundSurface gml:id="_Simple_BD.1_GroundSurface_1">
          <lod2MultiSurface>
            <gml:MultiSurface>
              <gml:surfaceMember>
